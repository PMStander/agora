...
name: pdf-generator
description:
  "Agora PDF Generator - Create PDF documents using React-PDF library (@react-pdf/renderer). Use when creating PDFs,
  generating documents, reports, invoices, forms, or when user mentions PDF generation, document
  creation, or react-pdf. Agora system skill for document output."
---
