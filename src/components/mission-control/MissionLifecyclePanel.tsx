...
export function MissionLifecyclePanel() {
  ...
  const chatAboutMission = useAgentStore((s) => s.chatAboutMission);
    ...
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between px-4 py-3 border-b border-zinc-800">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={handleChatAboutMission}
            className="flex items-center gap-1 px-2 py-1 text-xs bg-zinc-800 border border-zinc-700 text-zinc-400 rounded hover:text-zinc-200 hover:border-zinc-500 transition-colors"
            title="Chat with agent about this mission"
          >
