...
export function SettingsPanel({ isOpen, onClose }: SettingsPanelProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="bg-surface border border-border rounded-xl shadow-2xl w-full max-w-2xl max-h-[80vh] overflow-hidden">
        {/* Header */}
        ...
        {/* Content */}
        <div className="p-6 space-y-8 overflow-y-auto max-h-[calc(80vh-80px)]">
          {/* Appearance */}
          <section>
